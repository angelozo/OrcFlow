        ...
        if (path.contains("[")) {
            ...
            for (int j = 0; j < rel.length() - 1; j++) {
                ...
                if (data.get("type").equals("host")) {
                    // DPID
                    dpid = data.get("srcswitch").toString(); in = data.get("srcport").toString();
                    ...
                    if (data.get("srcswitch").equals(dataProx.get("srcswitch"))) { in = data.get("srcport").toString();
                    } else { in = data.get("dstport").toString();
                    }
                    ...
                    if (data.get("srcswitch").equals(dataProx.get("dstswitch"))) {
                        ...
                        out = dataProx.get("dstport").toString(); in = data.get("srcport").toString();
                        control = Util.getControl(JsonRel.get("start").toString());
                    } else if (data.get("srcswitch").equals(dataProx.get("srcswitch"))) {
                        dpid = data.get("srcswitch").toString();
                        out = dataProx.get("srcport").toString(); in = data.get("srcport").toString();
                        control = Util.getControl(JsonRel.get("start").toString());
                    } else if (data.get("dstswitch").equals(dataProx.get("dstswitch"))) {
                        dpid = data.get("dstswitch").toString();
                        out = dataProx.get("dstport").toString(); in = data.get("dstport").toString();
                        control = Util.getControl(JsonRel.get("end").toString());
                    } else {
                        dpid = data.get("dstswitch").toString();
                        out = dataProx.get("srcport").toString(); in = data.get("dstport").toString();
                        control = Util.getControl(JsonRel.get("end").toString());
                    }
                }
